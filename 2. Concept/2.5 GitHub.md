...
### 一般 merge（Create a merge commit）
...
> **優點**
> - main 歷史乾淨, 一個功能 = 一個 commit, 好讀
> - 開發中「修 typo」「測試又改」等小 commit 不會污染 main
> **缺點**
> - main 上看不到你當初那 5 次零碎 commit 的細節（PR 頁面還留著
> **適合**
> - 功能分支 commit 很碎、但併進 main 只想留一筆「完成功能 XXX」
> - 團隊希望 main 保持線性、好讀
...
## github or others ?
> github只是一個工具, 一個很好用的工具
> 但不表示只能用 github
> 如果有資安疑慮, 或是想自架git server, 除了github 也還有很多選擇
> 像是輕量的 gitea 以及 CI/CD整合的很好的 gitlab
